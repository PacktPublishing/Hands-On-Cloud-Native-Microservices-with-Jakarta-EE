...
import com.packtpub.vertx.footballplayermicroservice.service.FootballPlayerReactiveVerticle;
...
public class TestFootballPlayerReactiveVerticle {

    @BeforeEach
    void deploy_verticle(Vertx vertx, VertxTestContext testContext) {
        vertx.deployVerticle(new FootballPlayerReactiveVerticle(), testContext.
    ...
    void findAll(Vertx vertx, VertxTestContext testContext) throws
            Throwable {
        System.out.println("FIND ALL REACTIVE *****************");
    ...
    public void create(Vertx vertx, VertxTestContext context) {
        System.out.println("CREATE REACTIVE *****************");
    ...
    public void edit(Vertx vertx, VertxTestContext context) {
        System.out.println("EDIT REACTIVE *****************");
    ...
    void findOne(Vertx vertx, VertxTestContext testContext) throws
            Throwable {
        System.out.println("FIND One REACTIVE *****************");
    ...
    void delete(Vertx vertx, VertxTestContext testContext) throws
            Throwable {
        System.out.println("DELETE REACTIVE *****************");
