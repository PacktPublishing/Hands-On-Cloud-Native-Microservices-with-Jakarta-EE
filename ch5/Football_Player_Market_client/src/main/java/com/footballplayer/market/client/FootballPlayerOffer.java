...
public class FootballPlayerOffer implements Serializable {
    ...
    private static final long serialVersionUID = 8376015151598537707L;
    ...
    public FootballPlayerOffer(Long idFootballPlayer,
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.
                equals(this.idFootballManager, other.getIdFootballManager())) {
            return false;
        }
    ...
    public String toString() {
        return new StringBuilder().append("FootballPlayerOffer{").
